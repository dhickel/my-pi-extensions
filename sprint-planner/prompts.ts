...
- **Model Assignments**: exactly these three lines: \`- Implementation: deepseek/deepseek-v4-pro:max\`; \`- Validation: openai-codex/gpt-5.6-sol:medium\`; \`- Implementers: exactly one implementation agent per phase\`.
...
- **Final Integration**: exactly \`- Integration: after all phases PASS, run final integration validation with openai-codex/gpt-5.6-sol:medium.\`
